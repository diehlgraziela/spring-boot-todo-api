...
// Logger que printa no console as anotações da classe
@Slf4j(topic = "GLOBAL_EXCEPTION_HANDLER")
// Avisa ao spring que essa é uma classe que deve ser inicializada junto com o spring
@RestControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    // @Value pega o que está no application.properties
